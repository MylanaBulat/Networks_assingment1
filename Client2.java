...
public class Client2 extends Node {
     ...
     */
    Client2(String dstHost, int dstPort, int srcPort) {
        try {
    ...
    public synchronized void start() throws Exception {
        ...
        System.out.println("Client request for file : " + fname);
    ...
    public static void main(String[] args) {
        try {
            (new Client2(DEFAULT_DST_NODE, DEFAULT_DST_PORT, DEFAULT_SRC_PORT)).start();
